...
CREATE TABLE `Apelaciones` (
  `idapelacion` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `Apelaciones_ibfk_1` FOREIGN KEY (`idsolicitud`) REFERENCES `Solicitud` (`idsolicitud`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Apelaciones_ibfk_2` FOREIGN KEY (`idusuario`) REFERENCES `Usuario` (`idusuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
('111111111','Pedro','Alvarez'),
('123456789','Juan','Pérez'),
('222222222','Lucía','Figueroa'),
('321654987','Ana','Martínez'),
('333333333','Sofía','Contreras'),
('444444444','Diego','Mejía'),
('456789123','Carlos','López'),
('555555555','Valentina','Bravo'),
...
(23,13,2,'test\n:3','2024-11-26 20:00:52','pendiente');
...
(10,'456789123','Carlos','López','asdad@gmail.com',NULL,'suspendido','$2b$10$8ZTWqRYDY3ejQ56sGMYFy.L/h0Hss50MJ5RKtEV/JR0PX4S9VNz/.',NULL),
(12,'123456789','Juan','Pérez','aaaa@g.com',NULL,'admin','$2b$10$1t0LnJIBxOXbey71hH9ZSemIrdelw9ERhC4zgI6yMEUJ76Oe06gpi','/uploads/1732721903959-gatorisa.png'),
(13,'987654321','María','González','mariawa777@gmail.com','999888777','usuario','$2b$10$gsUN8hkIFEr3AJc37Wbize5bTmFuui5cPt47xLILHHm/ZaHzPOveW',NULL),
(14,'321654987','Ana','Martínez','correorecep2@email.com','111222333','recepcionista','$2b$10$7/2UZcxvBIkAUBMr9ePyc.t7tTGWlMI04tufIA.vIdNIKlw3FIjH.',NULL);
...
-- Dump completed on 2024-11-27 13:54:26
